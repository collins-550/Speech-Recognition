# A program called 'Guess the word'
...
def recognize_speech_from_mic(recognizer, microphone):
    ...
    # This function adjusts the recognizer sensitivity to ambient noise and record audio
    # from the microphone
    ...
    # This function tries to recognize the speech in the recording
